        ...
        <>
            ...
            <div className="phone-hidden">
                <div className="grid grid-cols-2 gap-4 mt-10">
                    <BlurFade delay={1.2}>
                        <div className="relative h-50 pt-11.5 border-2 border-neutral-200 dark:border-neutral-800/80 rounded-xl bg-neutral-50 dark:bg-neutral-950 overflow-hidden">
                    ...
                    <BlurFade delay={1.3}>
                        <div className="relative h-50 pt-2 pb-5 border-2 border-neutral-200 dark:border-neutral-800/80 rounded-xl bg-[#f6f6f6] dark:bg-neutral-950 overflow-hidden flex items-center justify-center">
