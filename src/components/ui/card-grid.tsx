...
export function CardGrid() {
    return (
        <>
            ...
            {/* Desktop */}
            < div className="hidden md:grid grid-cols-3 gap-4 mt-10 max-h-50" >
                <BlurFade delay={0.8}>
                ...
                <BlurFade delay={0.9}>
                    <div className="relative pb-3 h-full border-2 border-neutral-200 dark:border-neutral-800/80 rounded-xl bg-neutral-50 dark:bg-neutral-950 overflow-hidden flex items-center justify-center">
                        <div className="absolute top-2 left-2 text-[10px] bg-neutral-100 dark:bg-neutral-50/5 rounded-lg px-2 py-1 text-neutral-500 dark:text-neutral-300">Favorite Songs</div>
                        <Songs />
                    </div>
                </BlurFade>
                ...
                <BlurFade delay={1}>
                    <div className="relative pb-3 h-full border-2 border-neutral-200 dark:border-neutral-800/80 rounded-xl bg-[#f6f6f6] dark:bg-neutral-950 overflow-hidden flex items-center justify-center">
                        <div className="absolute top-2 left-2 z-10 text-[10px] bg-neutral-100 dark:bg-neutral-50/5 rounded-lg px-2 py-1 text-neutral-500 dark:text-neutral-300">Affiliated Team</div>
                        <Team />
                    </div>
                </BlurFade>
